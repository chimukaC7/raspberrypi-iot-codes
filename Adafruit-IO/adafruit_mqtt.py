...
# These functions will be called when the client connects, disconnects, or receives a message.
...
# If you want to run the client in the background, you can use the loop_background method.
...
# If you want to block your program until it receives a message, you can use the loop_blocking method.
