...
def main():
    ...
    for fname in os.listdir(LOCAL_DIR):
        # Skip non-whitelisted extensions if whitelist is set
        if EXT_WHITELIST and not any(fname.lower().endswith(ext) for ext in EXT_WHITELIST):
            continue
        ...
        # Only if upload succeeded, delete the local file
        try:
